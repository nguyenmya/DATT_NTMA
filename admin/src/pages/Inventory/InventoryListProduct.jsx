                                    ...
                                    <table className="Nbknf">
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td>{products.reduce(function (acc, obj) { return acc + obj.total_import_item; }, 0)}</td>
                                            </tr>
                                            <tr>
                                                <td colSpan={4}>
                                                    <span>Tổng đã bán</span>
                                                </td>
                                                <td>{products.reduce(function (acc, obj) { return acc + obj.sold; }, 0)}</td>
                                            </tr>
                                            <tr>
                                                <td colSpan={4}>
                                                    <span>Còn lại</span>
                                                ...
                                                <td>
                                                    <span className="sum">
                                                        {products.reduce(function (acc, obj) { return acc + obj.quantity_item; }, 0)}
                                                    </span>
                                                </td>
                                            </tr>
                                        </tfoot>
