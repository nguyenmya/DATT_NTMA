...
const columns = [
  ...
  { id: "id", label: "Mã SP", minWidth: 50, isShow: true },
  { id: "productMainImage", label: "Image", minWidth: 100, type: "image", isShow: false },
  { id: "productName", label: "Tên SP", minWidth: 100, type: "text", isShow: false },
  { id: "price", label: "Giá bán", minWidth: 100, type: "number", isShow: false, format: (value) => currency(value), },
  ...
  { id: "status", label: "Khuyến mãi", minWidth: 100, type: "number", isShow: false, format: (value) => value === 1 ? "Có" : "Không", },
];
