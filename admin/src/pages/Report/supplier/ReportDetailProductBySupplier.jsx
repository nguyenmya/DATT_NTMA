            ...
            <div className="card__body">
                ...
                <Grid item xs={12}>
                  {loading ? (
                    ...
                    <Paper className={classes.root}>
                      ...
                      <div className="report_total_list">
                        <div className="report_total_item">
                          <span>Tổng đã bán:</span>
                          <span>{data.reduce(function (acc, obj) { return acc + obj.quantity_sold; }, 0)}</span>
                        </div>
                        <div className="report_total_item">
                          <span>Tổng doanh thu:</span>
                          <span>{currency(data.reduce(function (acc, obj) { return acc + obj.total_price; }, 0))}</span>
                        </div>
                      </div>
                    </Paper>
                  )}
              ...
              <Grid item md={12}>
                <Link
                  ...
                  to="#"
                  onClick={() => history.push('/admin/report/supplier')}
                >
                  &lt;&lt; Quay lại
                </Link>
              </Grid>
