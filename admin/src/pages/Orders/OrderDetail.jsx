  ...
  const handleSubmitOrder = (e) => {
    ...
    switch (status) {
      ...
      case 2:
        ...
        if (orderInfo?.ship_type === 1 && orderInfo.status_order !== -1) {
          createOrderGHN(order)
            ...
            .catch((err) => {
              setLoading(false);
              toast.error("Lên đơn không thành công, vui lòng thao tác lại.")
              console.log(err)
            });
        } else if (orderInfo?.ship_type === 2 && orderInfo.status_order !== -1) {
          const order = {
            id: id
          };
        ...
        } else if (orderInfo.status_order === -1) {
          toast.error("Đơn hàng này đã bị huỷyrf")
          setLoading(false);
        }
        break;
      case 3:
