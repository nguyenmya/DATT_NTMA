...
function HistoryOrderDetail(props) {
    ...
    useEffect(() => {
        document.title = "Đơn hàng của tôi | fivver"
        getUser();
        getData();
                                                    ...
                                                    <Grid item sm={12}>
                                                        <div className="cRRvpz">
                                                            ...
                                                            <div className="gQjSfs">
                                                                ...
                                                                <div className="content">
                                                                    <p>Thời gian giao dự tính: {orderInfo?.expectedDate}</p>
                                                    ...
                                                    <Grid item sm={12}>
                                                        <div className="Nbknf">
                                                            <div style={{ padding: '15px 20px 15px 0', float: 'right' }}>
                                                                <p><span className="btn-tracking" onClick={handleClickOpenTracking}>Theo dõi đơn hàng</span></p>
                                                            </div>
                                                        </div>
                                                    </Grid>
                                                                            ...
                                                                            <tr key={index}>
                                                                                <td>
                                                                                    <div className="product-item">
                                                                                        <img src={item?.mainImage} alt="Sản phẩm" />
