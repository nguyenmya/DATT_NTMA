...
function PaymentPage(props) {
    ...
    const handlePayment = () => {
        if (cart?.cart_details.length === 0) {
            ...
            toast.error('Đặt hàng không thành công. Vui lòng cập nhật thông tin giao hàng !', {
                position: "top-right",
                theme: 'dark',
                autoClose: 2000,
                hideProgressBar: false,
        ...
        } else if(cart?.total_price > 1000000 && type !== 1) {
            toast.error('Đơn hàng giá trị quá lớn, vui lòng thanh toán tiền mặt khi nhận hàng!', {
                position: "top-right",
                theme: 'dark',
                autoClose: 2000,
                hideProgressBar: false,
