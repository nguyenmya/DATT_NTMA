...
const categories = [
  ...
  {
    title: 'Điện thoại',
    img: 'https://cf.shopee.vn/file/d106339c606523e756b635a1073b4a06',
...
export default function Category() {
  ...
  return (
    <>
      {/* <div className="row sm-gutter section__item" style={{backgroundColor: "#041E84", marginBottom: "50px", marginTop: "50px"}}>
        
        <div className="col l-12 m-12 c-12">
          <h1 className="home" style={{fontSize: "20px", color: "white", fontWeight:"500"}}>Sản Phẩm nổi bật</h1>
        </div>
                  ...
                  return (
                    <div className="container">
                      <Link to={item.url} className="featured__body-item" key={index}>
                        <img className="" src={item.img} alt="" style={{width:"70px", height:"70px"}} />
