...
export default function TrackingOrder({ order }) {
    ...
    const { createdDate, createdShipDate, completeDate, prepareDate, status_order } = order;
    ...
    return (
        <div className="card-body">
            <div className="steps">
                ...
                <div className={`step ${status_order >= 3 ? 'completed' : ''}`}>
                    <div className="step-icon-wrap">
            ...
            {/* <div className="ship_code">
                {
                    ship_order_code && ship_order_code !== null ? (
                        ...
                        <div className="product-review">
                             <span onClick={handleOpenTracking}>{ship_order_code}</span>
                        </div>
