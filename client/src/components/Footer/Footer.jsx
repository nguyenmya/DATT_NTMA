        ...
        <div className="grid wide">
          <div className="row">
            ...
            <div className="col l-2-4 m-4 c-6">
              ...
              <ul className="footer-list">
                <li className="footer-item">
                  <Link to="/dien-thoai" className="footer-link">
                    Điện thoại
                  </Link>
                </li>
                <li className="footer-item">
                  <Link to="/may-tinh-bang" className="footer-link">
                  Máy tính bảng
                  </Link>
                </li>
                <li className="footer-item">
                  <Link to="/laptop" className="footer-link">
                    Laptop
                  </Link>
                </li>
                <li className="footer-item">
                  <Link to="/thiet-bi-phu-kien" className="footer-link">
                    Phụ kiện
                  </Link>
                </li>
              </ul>
          ...
          <div className="row">
            <div className="col l-12 m-12 c-12">
              <p className="footer__copyright">
                © 2022 - Bản quyền thuộc về công ty 
              </p>
            </div>
          </div>
        </div>
